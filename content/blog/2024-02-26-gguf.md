...
{{< figure  width="400" src="[images/gguf_parasol.png](https://github.com/veekaybee/veekaybee.github.io/assets/3837836/dbbb8ee7-f19f-44df-bce7-2612817cacd2)">}}
...
In order to understand how GGUF works, though, we need to first take a deep dive into how machine learning models work and better understand what kinds of artifacts they produce. 

# What is a machine learning model? 

Let's start by describing a machine learning model. At its simplest, a model is a file or a collection of files that contain the model architecture and weights and biases of the model generated from a training loop. In LLM land, we're interested in Transformer-style models and architectures. Since many Transformer-style models are trained using PyTorch these days, artifacts use PyTorch's `save` implementation for serializing objects to disk.
