...
For a side project, I recently started working with `llama.cpp`, a  `C/C++`-based LLM inference engine targeting [M-series GPUs on Apple Silicon](https://github.com/ggerganov/llama.cpp/discussions/4167).  

When you run `llama.cpp`, you get a long log. 

{{< gist veekaybee 5236546a1b09fe9f03c42525871cf126 >}}

I started looking at the codebase to understand these logs.  There, I encountered GGUF. [GGUF (GPT-Generated Unified Format)](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) is the file format used to serve models on `llama.cpp` and other local runners like [Llamafile, Ollama and GPT4All.](https://semaphoreci.com/blog/local-llm)

To understand how GGUF works, though, we need to first take a deep dive into machine learning models and the kinds of artifacts they produce. 
