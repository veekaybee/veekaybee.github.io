...
{{< figure  width="600" src="images/gguf_parasol.png">}}
...
{% gist 5236546a1b09fe9f03c42525871cf126 %}

To understand this output, I started reading the codebase. There, I encountered GGUF. [GGUF (GPT-Generated Unified Format)](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) is the file format used to serve models on `llama.cpp` and other local runners like [Llamafile, Ollama and GPT4All.](https://semaphoreci.com/blog/local-llm).

In order to understand how GGUF works, let's first take a deep dive into how machine learning models work and what kinds of artifacts they produce. 
