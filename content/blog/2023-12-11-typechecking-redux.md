...
1. Python type-checking is very strongly decoupled from the actual runtime code and is not largely a user-level mechanism to make reading code much easier.
