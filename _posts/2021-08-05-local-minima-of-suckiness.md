...
The depressing answer is that all of these are completely invisible and almost not evident at all in the bottom line of any single given product or company, and it's almost impossible to account for them since knowledge work is still impossible to measure productivity-wise.

In most cases, they're a nice-to-have. And, additionally, at the executive level, it's very hard to tell good teams from bad teams, unless the good teams are also good at advertising themselves.
